...
(function () {
  ...
  const DICT = {
    ...
    "ebook.title": {
      es: `Regístrate y llévate el <span class="grad">ebook gratis</span>`,
      en: `Sign up and get the <span class="grad">free ebook</span>`,
      de: `Melde dich an und sichere dir das <span class="grad">Gratis-E-Book</span>`,
    ...
    "success.textDl": {
      ...
      en: `Tap the button to download your <strong>free ebook</strong>. We'll notify you at launch`,
      de: `Tippe auf den Button, um dein <strong>Gratis-E-Book</strong> herunterzuladen. Wir melden uns zum Start`,
      fr: `Appuie sur le bouton pour télécharger ton <strong>ebook gratuit</strong>. On te préviendra au lancement`,
      it: `Premi il pulsante per scaricare il tuo <strong>ebook gratis</strong>. Ti avviseremo al lancio`,
    },
