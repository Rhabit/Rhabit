...
(function () {
  ...
  const DICT = {
    ...
    "form.notify":    { es: "Enviarme el ebook gratis", en: "Send me the free ebook", de: "Gratis-E-Book senden", fr: "Envoyez-moi l'ebook gratuit", it: "Inviami l'ebook gratis" },
    "hero.hint": {
      es: `Pon tu correo y recibes el <strong>ebook gratis al instante</strong> + aviso y <strong>regalos en la app</strong> al lanzar.`,
      en: `Drop your email and get the <strong>free ebook instantly</strong> + a launch alert and <strong>in-app gifts</strong>.`,
      de: `Gib deine E-Mail ein und erhalte das <strong>E-Book sofort gratis</strong> + Start-Info und <strong>Geschenke in der App</strong>.`,
      fr: `Laisse ton e-mail et reçois l'<strong>ebook gratuit tout de suite</strong> + l'alerte de lancement et des <strong>cadeaux dans l'app</strong>.`,
      it: `Lascia la tua email e ricevi l'<strong>ebook gratis subito</strong> + avviso di lancio e <strong>regali nell'app</strong>.`,
    },
    "ebook.tag":       { es: "Gratis al registrarte", en: "Free when you sign up", de: "Gratis bei Anmeldung", fr: "Offert à l'inscription", it: "Gratis all'iscrizione" },
    "ebook.sub":       { es: "Cómo crear hábitos que realmente puedas mantener", en: "How to build habits you can actually keep", de: "Wie du Gewohnheiten aufbaust, die du wirklich hältst", fr: "Comment créer des habitudes que tu tiens vraiment", it: "Come creare abitudini che riesci davvero a mantenere" },
    "ebook.meta":      { es: "4,9 · Guía en PDF · Descarga inmediata", en: "4.9 · PDF guide · Instant download", de: "4,9 · PDF-Guide · Sofort-Download", fr: "4,9 · Guide PDF · Téléchargement immédiat", it: "4,9 · Guida in PDF · Download immediato" },
    "ebook.listlabel": { es: "Precio de lista", en: "List price", de: "Listenpreis", fr: "Prix conseillé", it: "Prezzo di listino" },
    "ebook.free":      { es: "GRATIS", en: "FREE", de: "GRATIS", fr: "GRATUIT", it: "GRATIS" },
    "ebook.deal": {
      es: `Deja tu correo y <strong>recibes el ebook gratis al instante</strong> + aviso y <strong>regalos en la app</strong> cuando lancemos.`,
      en: `Leave your email and <strong>get the ebook free instantly</strong> + a launch alert and <strong>in-app gifts</strong> when we launch.`,
      de: `Gib deine E-Mail ein und <strong>erhalte das E-Book sofort gratis</strong> + Start-Info und <strong>Geschenke in der App</strong> zum Launch.`,
      fr: `Laisse ton e-mail et <strong>reçois l'ebook gratuit tout de suite</strong> + l'alerte de lancement et des <strong>cadeaux dans l'app</strong>.`,
      it: `Lascia la tua email e <strong>ricevi l'ebook gratis subito</strong> + avviso e <strong>regali nell'app</strong> al lancio.`,
    },
    "ebook.cta":       { es: "Conseguirlo gratis", en: "Get it free", de: "Gratis sichern", fr: "L'obtenir gratuitement", it: "Ottienilo gratis" },
    ...
    "altch.hint": {
      es: `Te enviamos el <strong>ebook gratis</strong> por <strong id="altch-name">WhatsApp</strong> y te avisamos, con regalos en la app, al lanzar.`,
      en: `We'll send the <strong>free ebook</strong> on <strong id="altch-name">WhatsApp</strong> and notify you, with in-app gifts, at launch.`,
      de: `Wir senden das <strong>Gratis-E-Book</strong> über <strong id="altch-name">WhatsApp</strong> und benachrichtigen dich, mit Geschenken in der App, zum Start.`,
      fr: `On t'envoie l'<strong>ebook gratuit</strong> sur <strong id="altch-name">WhatsApp</strong> et on te prévient, avec des cadeaux dans l'app, au lancement.`,
      it: `Ti inviamo l'<strong>ebook gratis</strong> su <strong id="altch-name">WhatsApp</strong> e ti avvisiamo, con regali nell'app, al lancio.`,
    },
    ...
    "trust3": { es: "Regalos en la app para los primeros", en: "In-app gifts for the first ones", de: "Geschenke in der App für die Ersten", fr: "Cadeaux dans l'app pour les premiers", it: "Regali nell'app per i primi" },
    ...
    "form.consent": {
      es: "Acepto la <a href=\"/privacidad.html\">política de privacidad</a> y recibir el ebook y el aviso de lanzamiento.",
      en: "I accept the <a href=\"/privacidad.html\">privacy policy</a> and to receive the ebook and the launch notice.",
      de: "Ich akzeptiere die <a href=\"/privacidad.html\">Datenschutzerklärung</a> und den Erhalt des E-Books und der Start-Benachrichtigung.",
      fr: "J'accepte la <a href=\"/privacidad.html\">politique de confidentialité</a> et de recevoir l'ebook et l'avis de lancement.",
      it: "Accetto l'<a href=\"/privacidad.html\">informativa sulla privacy</a> e di ricevere l'ebook e l'avviso di lancio.",
    },
    "form.consentReq": {
